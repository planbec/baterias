		...
		<section id="registros-home" class="">
			...
			<div class="container cols cf">
				...
				<article class="servicio-resumen col2">
					<div class="text">
						<h3><strong>Creamos innovaciones</strong> en el &aacute;mbito de la <strong>personalizaci&oacute;n</strong> de los <strong>bater&iacute;as para autos </strong>con <strong>calidad, servicio</strong> y <strong>profesionalismo.</strong></h3>
					</div><!-- /.text -->
