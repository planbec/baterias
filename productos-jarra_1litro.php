	...
	<main id="content-area">
		...
		<article class="single-page portafolio-detalle">	
			...
			<div class="container page-content">
				...
				<h1><span>Jarra 1 litro</span></h1>

				<div class="portafolio-ampliado">
					<img src="img/prod_jarra_1litro.jpg" alt="Jarra 1 litro" class="imagen-destacada">
				</div>
				
				<div class="portafolio-ampliado">
				<p><strong>Especificaciones:</strong></p>
				<ul>
					<li>Botella automática de plástico resistente a los ácidos de las baterías</li>
					<li>Para rellenar los vasos de la batería con agua destilada</li>
					<li>La boquilla está provista de un dispositivo que detiene automáticamente la salida de líquido una
					<li>vez el vaso está lleno</li>
					<li>Evita todo riesgo de derrame</li>
					<li>Fácil de usar</li>
