	...
	<main id="content-area">
		...
		<article class="single-page portafolio-detalle">	
			...
			<div class="container page-content">
				...
				<h1><span>Cargador IC-10 (1-10 baterias)</span></h1>

				<div class="portafolio-ampliado">
					<img src="img/prod_cargador_ic10.jpg" alt="Cargador IC-10 (1-10 baterias)" class="imagen-destacada">
				</div>
				
				<div class="portafolio-ampliado">
				<p><strong>Especificaciones:</strong></p>
				<ul>
					<li>El cargador de Baterías modelo (IC-10), está diseñado para proveer el voltaje y la corriente exacta para Baterías de 12V; desde una hasta 10 Baterias</li>
					<li>La conexión de las baterías es de tipo en serie</li>
				</ul>
				</div>
