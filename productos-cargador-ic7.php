	...
	<main id="content-area">
		...
		<article class="single-page portafolio-detalle">	
			...
			<div class="container page-content">
				...
				<h1><span>Cargador IC-7 (1-7 baterias)</span></h1>

				<div class="portafolio-ampliado">
					<img src="img/prod_cargador_ic7.jpg" alt="Cargador IC-7 (1-7 baterias)" class="imagen-destacada">
				</div>
				
				<div class="portafolio-ampliado">
				<p><strong>Especificaciones:</strong></p>
				<ul>
					<li>El cargador de Baterías modelo (IC-7), está diseñado para proveer el voltaje y la corriente exacta para Baterías de 12V; desde una
hasta 7 Baterías</li>
