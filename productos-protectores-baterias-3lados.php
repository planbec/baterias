	...
	<main id="content-area">
		...
		<article class="single-page portafolio-detalle">	
			...
			<div class="container page-content">
				...
				<h1><span>Protectores para baterías 3 lados</span></h1>

				<div class="portafolio-ampliado">
					<img src="img/prod_protectores_baterias.jpg" alt="Protectores para baterías 3 lados" class="imagen-destacada">
				</div>
				
				<div class="portafolio-ampliado">
				<p><strong>Especificaciones:</strong></p>
				<ul>
					<li>Reduce considerablemente el calor generado por el motor</li>
